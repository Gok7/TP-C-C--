...
${OBJECTDIR}/C_AQUARIUM.o: C_AQUARIUM.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/C_AQUARIUM.o C_AQUARIUM.cpp

${OBJECTDIR}/C_CUBE.o: C_CUBE.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/C_CUBE.o C_CUBE.cpp

${OBJECTDIR}/C_ESPACE.o: C_ESPACE.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/C_ESPACE.o C_ESPACE.cpp
...
${OBJECTDIR}/C_LISTE_POISSON.o: C_LISTE_POISSON.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/C_LISTE_POISSON.o C_LISTE_POISSON.cpp

${OBJECTDIR}/C_POISSON.o: C_POISSON.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/C_POISSON.o C_POISSON.cpp

${OBJECTDIR}/C_SPHERE.o: C_SPHERE.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/C_SPHERE.o C_SPHERE.cpp
