...
public:
    ...
    C_COMPLEXE()=default;
    C_COMPLEXE(float P_Reel,float P_Imaginaire=0.0f);
    C_COMPLEXE(const char* P_Chaine);
    
    void Initialise_Toi(float P_Reel, float p_Imaginaire,char P_Caractere_Imaginaire);
    void Initialise_Toi();
    ...
    void Set_Caractere_Imaginaire(const char P_Caractere);
protected:
    static char Caractere_Imaginaire;
    float Reel;
    float Imaginaire;
