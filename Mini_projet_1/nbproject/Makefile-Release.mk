...
${OBJECTDIR}/C_CAPTEUR.o: C_CAPTEUR.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/C_CAPTEUR.o C_CAPTEUR.cpp

${OBJECTDIR}/C_CUVE.o: C_CUVE.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/C_CUVE.o C_CUVE.cpp

${OBJECTDIR}/C_POMPE.o: C_POMPE.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/C_POMPE.o C_POMPE.cpp

${OBJECTDIR}/C_PROCESS.o: C_PROCESS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/C_PROCESS.o C_PROCESS.cpp

${OBJECTDIR}/C_VANNE.o: C_VANNE.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/C_VANNE.o C_VANNE.cpp
